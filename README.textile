...
The problem is encoding related. To circumvent it, Base64 encode the epub on the server, and Base64 decode it again on the client.

<pre><code>// Server side, here with Ruby. The approach to any language.
def serve_epub
